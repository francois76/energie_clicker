...
export const TECHNOLOGIES: Technology[] = [
  ...
  { id: 'early_fuels', name: 'Premiers carburants', era: 'electricite_petrole', kind: 'producer', description: 'Stockage confortable et forte inertie. C’est pratique, donc dangereux.', asset: 'assets/technologies/early_fuels.svg', tags: ['fuel', 'fossil'], productionPerSecond: { fuel: 11 }, storageBonus: { fuel: 360 }, hiddenPollutionDebtPerSecond: 0.055, pollutionPerSecond: 0.055, purchaseOptions: [{ id: 'oil_depot', label: 'Dépôt pétrolier', cost: { heat: 200, mechanical: 120 }, buildTimeSeconds: 32, pollutionDebt: 4 }, { id: 'tank_farm', label: 'Parc de cuves', cost: { heat: 290, mechanical: 190 }, buildTimeSeconds: 16, pollutionDebt: 5 }], removable: true, documentaryId: 'tech_fuels' },
  ...
  { id: 'energy_efficiency', name: 'Efficacité énergétique', era: 'trente_glorieuses', kind: 'conversion', description: 'Réduit une partie des consommations de chaleur, carburants et électricité. Moins spectaculaire qu’une centrale, souvent décisif.', asset: 'assets/technologies/energy_efficiency.svg', tags: ['efficiency', 'conversion'], consumptionPerSecond: { heat: -3.5, fuel: -3.5, electricity: -1.5 }, pollutionDeltaPerSecond: -0.025, maxQuantity: 4, purchaseOptions: [{ id: 'renovation_program', label: 'Programme de sobriété technique', cost: { electricity: 100, mechanical: 180, heat: 220 }, buildTimeSeconds: 50 }, { id: 'industrial_standards', label: 'Normes industrielles', cost: { electricity: 180, mechanical: 320, heat: 320 }, buildTimeSeconds: 24 }], documentaryId: 'tech_efficiency' },
  ...
  { id: 'heat_pumps', name: 'Pompes à chaleur', era: 'moderne_futur', kind: 'conversion', description: 'Baisse carburants et chaleur fossile, mais augmente la tension électrique.', asset: 'assets/technologies/heat_pumps.svg', tags: ['conversion', 'electricity', 'heating'], consumptionPerSecond: { fuel: -8.5, heat: -5.5, electricity: 6.5 }, pollutionDeltaPerSecond: -0.08, maxQuantity: 4, purchaseOptions: [{ id: 'housing_program', label: 'Rénovation + PAC', cost: { electricity: 210, mechanical: 180, heat: 120 }, buildTimeSeconds: 58 }, { id: 'mass_rollout', label: 'Déploiement massif', cost: { electricity: 340, mechanical: 320, heat: 200 }, buildTimeSeconds: 26 }], documentaryId: 'tech_heat_pumps' },
  { id: 'electric_vehicles', name: 'Véhicules électriques', era: 'moderne_futur', kind: 'conversion', description: 'Déplace le transport des carburants vers l’électricité.', asset: 'assets/technologies/electric_vehicles.svg', tags: ['conversion', 'transport', 'electricity'], consumptionPerSecond: { fuel: -12, electricity: 10 }, pollutionDeltaPerSecond: -0.09, maxQuantity: 4, purchaseOptions: [{ id: 'charging_network', label: 'Recharge + véhicules', cost: { electricity: 290, mechanical: 260 }, buildTimeSeconds: 62 }, { id: 'battery_supply_chain', label: 'Chaîne batteries', cost: { electricity: 460, mechanical: 430, fuel: 80 }, buildTimeSeconds: 28 }], documentaryId: 'tech_electric_vehicles' },
